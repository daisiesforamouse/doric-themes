        ...
        `(progn
           ...
           (let ,palette
             (custom-theme-set-faces
              ...
              ,@(doric-themes-prepare-faces doric-themes-diff-added-faces :background '(doric-themes-adjust-value bg-green -50) :foreground 'fg-neutral)
              ...
              ,@(doric-themes-prepare-faces doric-themes-diff-changed-faces :background '(doric-themes-adjust-value bg-yellow -50) :foreground 'fg-neutral)
              ...
              ,@(doric-themes-prepare-faces doric-themes-diff-removed-faces :background '(doric-themes-adjust-value bg-red -50) :foreground 'fg-neutral)
